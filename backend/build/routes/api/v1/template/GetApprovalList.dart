...
Future<Response> onRequest(RequestContext context) async {
  ...
  try {
    ...
    final externalResponse = await client
        .get(
          Uri.parse('$kBaseUrl${ExternalApi.approvalList}'),
          headers: {
    ...
    print('[GET APPROVAL LIST] External API status: ${externalResponse.statusCode}');
    ...
    return Response.json(
      ...
      body: ApiResponse.error(message: 'Failed to fetch approval list').toJson(),
    );
  } catch (e) {
    return Response.json(
      statusCode: HttpStatus.internalServerError,
      body: ApiResponse.error(message: 'Approval list service unavailable: $e')
          .toJson(),
    );
  }
}
