...
Future<Response> onRequest(RequestContext context) async {
  ...
  try {
    ...
    print('[OPERATIONS] External API status: ${externalResponse.statusCode}');
    ...
    return Response.json(
      ...
      body: ApiResponse.error(message: 'Failed to fetch operations').toJson(),
    );
  } catch (e) {
    return Response.json(
      statusCode: HttpStatus.internalServerError,
      body: ApiResponse.error(message: 'Operations service unavailable: $e').toJson(),
    );
  }
}
