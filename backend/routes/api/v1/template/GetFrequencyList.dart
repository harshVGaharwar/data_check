...
Future<Response> onRequest(RequestContext context) async {
  ...
  try {
    ...
    final externalResponse = await client
        .get(
          Uri.parse('$kBaseUrl${ExternalApi.getFrequencyList}'),
          headers: {
    ...
    return Response.json(
      ...
      body: ApiResponse.error(message: 'Failed to fetch frequency list').toJson(),
    );
  } catch (e) {
    return Response.json(
      statusCode: HttpStatus.internalServerError,
      body: ApiResponse.error(message: 'Frequency list service unavailable: $e')
          .toJson(),
    );
  }
}
