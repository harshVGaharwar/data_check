  ...
  Widget build(BuildContext context) {
    return Consumer<PipelineController>(
      builder: (context, ctrl, _) {
        final hasOut = ctrl.nodes.any((n) => n.type == NodeType.output);
        ...
        return Container(
          ...
          child: Row(
            children: [
              ...
              Text(hasOut && hasSrc ? '✓ Ready to run' : 'Add nodes', style: const TextStyle(color: AppColors.textDim, fontSize: 10)),
            ],
          ),
        );
      },
