...
class _ConfigPreviewSheet extends StatelessWidget {
  ...
  Widget _uniMailingOutputSection() {
    ...
    // Mandatory fields
    final mandatoryRows = _kMandatoryFields.map((f) {
                    ...
                    : [
                        ...
                        _tile(
                          ...
                          subtitle: isUniMailing
                              ? '${ctrl.uniMailingMandatory.values.where((v) => v.isNotEmpty).length} / ${_kMandatoryFields.length} mandatory fields mapped'
