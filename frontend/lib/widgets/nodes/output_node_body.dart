...
part 'output_node/dynamic_unimailing_section.dart';
part 'output_node/config_preview_sheet.dart';
...
class _OutputNodeBodyState extends State<OutputNodeBody> {
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (isStaticUniMailing) ...[
                    ...
                    const SizedBox(height: 8),
                    _UniMailingSection(ctrl: ctrl, sourceNodes: allSourceNodes),
                    const SizedBox(height: 12),
                  ],

                  // ── Dynamic UniMailing section (3rd case) ──
                  if (isDynamicUniMailing) ...[
                    _DynamicUniMailingOutputSection(
                      ctrl: ctrl,
  ...
  void _showConfigPreview(
    ...
    showModalBottomSheet(
      ...
      builder: (ctx) => _ConfigPreviewSheet(
        ctrl: ctrl,
        master: master,
