...
class ReviewerItem {
  ...
  // List<dynamic> for Template Configuration (one entry per DynamicId pipeline).
  ...
  factory ReviewerItem.fromJson(Map<String, dynamic> json) {
    return ReviewerItem(
  ...
  static dynamic _parseJsonData(dynamic v) {
    ...
    if (v is String && v.trim().isNotEmpty) {
      try {
        ...
        if (decoded is Map)
          return decoded.map((k, e) => MapEntry(k.toString(), e));
